...
describe DiscourseJira::IssuesController do
  ...
  describe '#preflight' do
    ...
    it 'should return a list of projects and issue types' do
      ...
      issue_type_1 = project.issue_types.create!(id: 10001, uid: 2001, name: 'Task')
      issue_type_2 = project.issue_types.create!(id: 10002, uid: 2002, name: 'Epic')
  ...
  describe '#fields' do
    ...
    it 'returns a list of fields for a given issue type' do
      ...
      field_2.options.create!(jira_id: "123", value: 'iOS')
      ...
      expect(response.parsed_body["fields"]).to eq([
        ...
        { 'field_type' => field_2.field_type, 'key' => field_2.key, 'name' => field_2.name, 'options' => [{ 'id' => '123', 'value' => 'iOS' }], 'required' => field_2.required },
      ])
    end
  end
