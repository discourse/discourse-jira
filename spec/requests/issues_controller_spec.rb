...
describe DiscourseJira::IssuesController do
  ...
  describe '#create' do
    ...
    it 'create a Jira issue and ' do
      ...
      stub_request(:get, 'https://example.com/rest/api/2/issue/10041')
        .to_return(status: 200, body: issue_response)
  ...
  describe '#attach' do
    ...
    it 'attach an existing Jira issue to post' do
      ...
      stub_request(:get, 'https://example.com/rest/api/2/issue/10041')
        .to_return(status: 200, body: issue_response)
      stub_request(:get, 'https://example.com/rest/api/2/issue/DIS-42')
        .to_return(status: 200, body: issue_response)

      expect do
        post '/jira/issues/attach.json', params: {
          issue_key: 'DIS-42',
          topic_id: post.topic_id,
          post_number: post.post_number,
        }
